...
package com.sonicvault.app.lastfm
...
import com.sonicvault.app.lastfm.models.LastFmError
import com.sonicvault.app.lastfm.models.TokenResponse
import java.net.URI
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        headers.append(HttpHeaders.UserAgent, "SonicVault (https://github.com/rukamori/SonicVault)")
        val paramsForSig =
            mutableMapOf(
                "method" to method,
                "api_key" to apiKey,
