...
-keep class com.sonicvault.app.models.PersistQueue { *; }
-keep class com.sonicvault.app.models.PersistPlayerState { *; }
-keep class com.sonicvault.app.models.QueueData { *; }
-keep class com.sonicvault.app.models.QueueType { *; }
-keep class com.sonicvault.app.playback.queues.** { *; }
...
-keep class io.ktor.** { *; }
-dontwarn io.ktor.**
-keep class com.sonicvault.app.moriextractor.BackendExtractorResponse { *; }
