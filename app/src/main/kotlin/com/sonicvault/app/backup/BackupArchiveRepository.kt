...
package com.sonicvault.app.backup
...
import com.sonicvault.app.extensions.zipOutputStream
...
class BackupArchiveRepository
    ...
    constructor(
        ...
        private suspend fun writeSettingsToXml(
            ...
            serializer.startTag(null, "SonicVaultBackup")
            ...
            serializer.endTag(null, "SonicVaultBackup")
