...
import com.sonicvault.app.logcat.LogcatLevel
import com.sonicvault.app.ui.utils.backToMain
import com.sonicvault.app.viewmodels.LogcatEffect
import com.sonicvault.app.viewmodels.LogcatScreenState
import com.sonicvault.app.viewmodels.LogcatUiEntries
import com.sonicvault.app.viewmodels.LogcatUiEntry
import com.sonicvault.app.viewmodels.LogcatUiModel
import com.sonicvault.app.viewmodels.LogcatViewModel
import com.sonicvault.app.ui.component.IconButton as SonicVaultIconButton
            ...
            when (effect) {
                ...
                is LogcatEffect.Export -> {
                    val exportIntent =
                        Intent(Intent.ACTION_SEND).apply {
                            type = "text/plain"
                            clipData = ClipData.newRawUri("sonicvault-log.txt", effect.uri)
