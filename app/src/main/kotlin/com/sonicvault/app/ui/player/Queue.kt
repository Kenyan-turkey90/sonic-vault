...
import com.sonicvault.app.constants.QueueEditLockKey
...
import com.sonicvault.app.ui.component.MediaMetadataListItem
import com.sonicvault.app.ui.component.TextFieldDialog
import com.sonicvault.app.ui.menu.AddToPlaylistDialog
import com.sonicvault.app.ui.menu.PlayerMenu
import com.sonicvault.app.ui.utils.ShowMediaInfo
import com.sonicvault.app.utils.oem.SystemMediaControlResolver
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.sonicvault.app.together.TogetherSessionState.Joined &&
            (togetherSessionState as com.sonicvault.app.together.TogetherSessionState.Joined).role is com.sonicvault.app.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.sonicvault.app.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.sonicvault.app.together.TogetherRole.Guest
                                                                if (isGuest) {
