...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.sonicvault.app.together.JoinDecision,
    ) : TogetherClientEvent

    data class HostTransferred(
        val transfer: com.sonicvault.app.together.HostTransferred,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.sonicvault.app.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.sonicvault.app.together.JoinDecision -> {
                            ...
                            is com.sonicvault.app.together.HostTransferred -> {
                                if (message.sessionId == sessionId) {
