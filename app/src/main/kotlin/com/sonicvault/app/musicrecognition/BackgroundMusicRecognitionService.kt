...
class BackgroundMusicRecognitionService : Service() {
    ...
    companion object {
        private const val ActionRecognizePlayback =
            "com.sonicvault.app.action.RECOGNIZE_DEVICE_PLAYBACK"
        private const val ActionRecognizeMicrophone =
            "com.sonicvault.app.action.RECOGNIZE_MICROPHONE"
        private const val ActionCancel =
            "com.sonicvault.app.action.CANCEL_BACKGROUND_RECOGNITION"
