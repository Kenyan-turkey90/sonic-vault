...
package com.sonicvault.app.cast
...
private class GmsCastMediaItemConverter(
    ...
    private fun MediaInfo?.toAppMediaMetadata(mediaId: String): com.sonicvault.app.models.MediaMetadata {
        val castMetadata = this?.metadata
        val title = castMetadata?.stringValue(CastMetadata.KEY_TITLE) ?: mediaId
        val artistText =
        ...
        return com.sonicvault.app.models.MediaMetadata(
            ...
            album =
                albumTitle?.let {
                    com.sonicvault.app.models.MediaMetadata.Album(
                        id = it,
                        title = it,
                    )
                },
    ...
    private fun openResolvedRemoteSource(
        ...
        val connection =
            (URL(resolvedUri.toString()).openConnection() as HttpURLConnection).apply {
                ...
                setRequestProperty("User-Agent", "SonicVault Cast")
